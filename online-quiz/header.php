...
function timer() {
        ...
        xhttp.onreadystatechange = function() {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                if (xhttp.responseText == "00:00:01") {
                    window.location = "result.php";
                }
                document.getElementById("countdown").innerHTML = xhttp.responseText;
            }
        };
        xhttp.open("GET", "ajax/load_timer.php", true);
        xhttp.send(null);
}
</script>
<!doctype html>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="select_quiz.php" class="nav-link">Select Exam</a></li>
                                                <li class="nav-item"><a href="past_results.php" class="nav-link">Past Results</a></li>
